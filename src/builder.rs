...
use yarvk::{
    CompositeAlphaFlagsKHR, DebugUtilsMessageSeverityFlagsEXT, Extent2D, PhysicalDeviceType,
    PresentModeKHR, QueueFlags, SurfaceTransformFlagsKHR,
};
...
impl RendererBuilder {
    ...
    pub fn build(self, window: &dyn HasRawWindowHandle) -> Result<Renderer, yarvk::Result> {
        ...
        let queue_manager = QueueManager::new(pdevice)?;
